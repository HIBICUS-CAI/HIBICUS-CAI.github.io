...
前身としてのHycFrame2Dと比べて最大な改善点は、**描画パイプラインの進化**と**ObjectとComponentの保存・管理の仕方**です。描画パイプラインは[03_RenderSystem_DX11](https://github.com/HIBICUS-CAI/PreWorkRenderEngine)にかかっているので、[この文章](rendersystem_jp.md)に紹介させていただきます。
...
- キャッシュ最適化
  - 現在のキャッシュブラシュアップはただ以前のものと比べて優れているだけ、でも色んなところはまだ全然Cache Friendlyと言えない、もっと効率いいデータ構造が必要です。
- 機能追加
